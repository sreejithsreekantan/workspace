...
object GenericRangeOperation {
  println("Welcome to the Scala worksheet")       //> Welcome to the Scala worksheet
	...
	def SumRange(f: Int => Int)(a: Int, b: Int): Int =
		RangeOper(f)((x, y) => x+y)(a, b) //> SumRange: (f: Int => Int)(a: Int, b: Int)Int
	
	
	RangeOper1(x => x)((x, y) => x+y)(1,5)    //> res0: Int = 15
	RangeOper(x => x)((x, y) => x+y)(1,5)     //> res1: Int = 15
	SumRange(x => x)(1,5)                     //> res2: Int = 15
	RangeOper1(x => x)((x, y) => x*y)(1,5)    //> res3: Int = 120
	RangeOper(x => x)((x, y) => x*y)(1,5)     //> res4: Int = 120
	ProductRange(x => x)(1,5)                 //> res5: Int = 120
	RangeOper1(x => x*x)((x, y) => x+y)(1,5)  //> res6: Int = 55
	RangeOper(x => x*x)((x, y) => x+y)(1,5)   //> res7: Int = 55
}